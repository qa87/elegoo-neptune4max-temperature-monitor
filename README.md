...
- **Системные уведомления Windows** - нативные уведомления операционной системы при достижении целевой температуры
...
1. **Показывает системное уведомление Windows** с информацией о достижении цели
